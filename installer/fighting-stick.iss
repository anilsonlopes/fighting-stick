...
Source: "..\apps\desktop\assets\icon.ico"; DestDir: "{app}"; Flags: ignoreversion

[Tasks]
Name: "desktopicon"; Description: "Criar um atalho na área de trabalho"; GroupDescription: "Atalhos adicionais:"

[Icons]
Name: "{group}\Fighting Stick MIDI"; Filename: "{app}\FightingStickMidi.exe"; IconFilename: "{app}\icon.ico"
Name: "{userdesktop}\Fighting Stick MIDI"; Filename: "{app}\FightingStickMidi.exe"; IconFilename: "{app}\icon.ico"; Tasks: desktopicon
