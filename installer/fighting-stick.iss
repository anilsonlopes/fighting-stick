...
[Icons]
Name: "{group}\Fighting Stick MIDI"; Filename: "{app}\FightingStickMidi.exe"
Name: "{userdesktop}\Fighting Stick MIDI"; Filename: "{app}\FightingStickMidi.exe"; Tasks: desktopicon
